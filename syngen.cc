...
void SyntheticTraveltimeGenerator2d::conduct()
{
	...
	//double pwater = 1.0/1.5;//ojo
        double pwater = 1.0/smesh.atWater();// BIEN

//        cerr << "DENTRO SYNGEN: " << pwater << ", " << 1.0/pwater;
    ...
    for (int isrc=1; isrc<=src.size(); isrc++){//donde acaba?

...
//////			       int&, int&, int&, int&) const;
    void pickPath(const Point2d& rcv, Array1d<Point2d>& path) const;
    void pickPathRcvW(const Point2d& rcv, Array1d<Point2d>& path,
				      int& i0, int& i1) const;
	void pickReflPath(const Point2d& rcv, Array1d<Point2d>& path,
				 int& ir0, int& ir1) const;
	void pickReflPathRcvW(const Point2d& rcv, Array1d<Point2d>& path,
					  int& i0, int& i1, int& ir0, int& ir1) const;
	void pickPathSrcW(const Point2d& rcv, Array1d<Point2d>& path,
				      int& is0, int& is1) const;
	void pickPathSrcWRcvW(const Point2d& rcv, Array1d<Point2d>& path,
				      int& i0, int& i1, int& is0, int& is1) const;
	void pickReflPathSrcW(const Point2d& rcv, Array1d<Point2d>& path,
					  int& is0, int& is1, int& ir0, int& ir1) const;
	void pickReflPathSrcWRcvW(const Point2d& rcv, Array1d<Point2d>& path,
...
private:
	...
	////////////
	void findRayExitPoint(const Point2d& src, int& cur) const;
